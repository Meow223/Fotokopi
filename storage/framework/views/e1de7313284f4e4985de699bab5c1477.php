...
<nav x-data="{ open: false }" class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
...
<?php endif; ?>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('katalog')); ?>">Katalog</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('print') ? 'active' : ''); ?>" href="/print">Print</a>
                </li>
            </ul>
            <div style="margin-right: 20px;">
                <button class="btn btn-outline-secondary" onclick="masuk()">Masuk</button>
            </div>

            <div>
                <button class="btn btn-outline-secondary" onclick="daftar()">Daftar</button>
            </div>
...
<?php /**PATH C:\xampp\htdocs\foto\resources\views/includes/navbar.blade.php ENDPATH**/ ?>