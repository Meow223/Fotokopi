                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5>Pesanan anda sudah sukses dilkaukan selanjutnya untuk pembayaran silahkan transfer di
                            ...
                            <strong>Rp. {{ number_format($pesanan->jumlah_harga) }}</strong></h5>
                    </div>
                </div>
                <div class="card mt-2">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($pesanan_details as $pesanan_detail)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>
                                                <img src="{{ url('image') }}/{{ $pesanan_detail->barang->gambar_barang }}"
                                                    width="100" alt="...">
                                            </td>
                                            <td>{{ $pesanan_detail->barang->nama_barang }}</td>
                                            <td>{{ $pesanan_detail->jumlah }} buah </td>
                                            <td align="right">Rp. {{ number_format($pesanan_detail->barang->harga_satuan) }}
                                            </td>
