<div style="width: 280px" class="shadow rounded-3 p-4 ms-3">
    <img src="{{asset('images/pulpen.jpg')}}" class="mx-auto d-block"onclick="beli()" width="200" height="200"/>
    <hr class="hr" />
...
<div style="width: 280px" class="shadow rounded-3 p-4 ms-3">
    <img src="{{asset('images/pens.jpg')}}" class="mx-auto d-block"onclick="beli()" width="200" height="200"/>
    <hr class="hr" />
...
<div style="width: 280px" class="shadow rounded-3 p-4 ms-3">
    <img src="{{asset('images/spidol.jpg')}}" class="mx-auto d-block"onclick="beli()" width="200" height="200"/>
    <hr class="hr" />
...
<div style="width: 280px" class="shadow rounded-3 p-4 ms-3">
    <img src="{{asset('images/gunting.jpg')}}" class="mx-auto d-block"onclick="beli()" width="200" height="200"/>
    <hr class="hr" />
